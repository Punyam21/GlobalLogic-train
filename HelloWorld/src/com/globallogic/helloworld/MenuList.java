		...
		while (t == true) {
			...
			if (t == true) {
				...
				case 5: {
					...
					Collections.sort(pun,new SortBy());
...
class emplo/* implements Comparator<emplo>*/{
	private String name;
	private int value;
	private int salary;
	private int id;
...
//public static Comparator<emplo> na=new Comparator<emplo>()
//{
//    public int compare(emplo h1, emplo h2)
//    {
