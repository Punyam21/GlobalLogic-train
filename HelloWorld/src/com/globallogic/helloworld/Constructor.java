...
class Constructoris {
	...
	Constructoris() // default constructor
	{
		name="Agam";
		rollno=1812213013;
		friend="Punyam";
	...
	Constructoris(String name, int rollno, String friend) //parametrized constructor
	{
		this.name = name;
		this.rollno = rollno;
		this.friend = friend;	
...
public class Constructor {
	public static void main(String[] args) {
		...
		Constructoris cs = new Constructoris("hkhh",656565,"ddfdf"); // by default default constructor andar ban jaata hai
